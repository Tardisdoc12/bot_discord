...
@bot.tree.sync_command(name="add_city", description="Ajoute une ville au profil")
...
@bot.tree.sync_command(name="update_city", description="Met à jour une ville")
...
@bot.tree.sync_command(name="delete_city", description="Supprime une ville")
